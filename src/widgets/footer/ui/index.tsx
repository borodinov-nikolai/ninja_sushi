    ...
    return (
        <footer className={styles.root} >
            ...
            <div className={styles.location} >
                ...
                <div className={styles.map} ><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2819.2626130929425!2d38.97086987713647!3d45.039892461647945!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40f04f9c2224cafb%3A0x5c1c5247a63a9634!2z0JPQsNC70LXRgNC10Y8g0JrRgNCw0YHQvdC-0LTQsNGA!5e0!3m2!1sru!2sru!4v1705868953707!5m2!1sru!2sru" width="600" height="450" style={{ border: "0" }} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe></div>
            </div>
            ...
            <div className={styles.aboutUs + ' container'} >
                <p className={styles.abouUs_text} >В Сети полно всевозможных сервисов учета, начиная от учета времени или калорий, заканчивая учетом финансов. </p>
